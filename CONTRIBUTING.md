...
main          ← 배포 가능 상태만. 직접 push 금지.
  └── dev     ← 개발 통합 브랜치. feature 머지 대상.
       ├── feature/woolim-audio-extractor
...
# 2. feature 브랜치 생성
git checkout -b feature/woolim-layer1-audio
...
# 4. 원격에 push
git push origin feature/woolim-layer1-audio
...
git checkout dev
git pull origin dev
git branch -d feature/woolim-layer1-audio
```
