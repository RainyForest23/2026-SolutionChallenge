...
export const DEFAULT_SETTINGS: ChannelSettings = {
  baseMoods: [
    { id: 'tension',    label: '긴장감·압박',  description: '불안, 서스펜스, 고조되는 압박감', color: '#C81C30', enabled: false },
    { id: 'sadness',    label: '슬픔·여운',    description: '상실, 고독',                       color: '#0388A6', enabled: false },
    { id: 'excitement', label: '고양·벅참',    description: '흥분, 결의, 장엄한 상승감',         color: '#F9B95C', enabled: false },
    { id: 'warmth',     label: '따뜻함·위로',  description: '온기, 평화, 치유의 감각',           color: '#A6B13C', enabled: false },
    { id: 'mystery',    label: '신비·몽환',    description: '미지, 환상, 꿈결 같은 분위기',       color: '#A1A1F7', enabled: false },
  ],
  moodIntensity: 50,
  dynamicEvents: [
