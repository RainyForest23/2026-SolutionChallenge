...
### 4.1 `VideoRepository` (`video_repo.py`)
...
### 4.3 `AnalysisResultRepository` (`analysis_result_repo.py`)
...
### 4.4 `FeedbackRepository` (`feedback_repo.py`)
...
### 5.2 `VideoService` (`video_service.py`)
...
### 5.3 `AnalysisResultService` (`analysis_result_service.py`)
...
### 5.4 `FeedbackService` (`feedback_service.py`)
